...
describe('Random key cipher', () => {
    ...
    test('is reversible', () => {
        const plaintext =
            'abcdefghijadkfsjklfjsakasdjflkjsadoihspihqernqpndosanghidhsafohlqhiohdsagoihasofdnasldkfjasfihasoifdh';
        const ciphered = cipher.encode(plaintext);
        // expect(cipher.decode('lvedwwojwi')).toEqual(plaintext);
...
describe('Substitution cipher', () => {
    ...
    test('custom', () => {
        expect(new Cipher('ddd').encode('xyz')).toEqual('abc');
    });
